...
class OTPCopyWidget extends StatefulWidget {
  const OTPCopyWidget({super.key});

  @override
  State<OTPCopyWidget> createState() => _OTPCopyWidgetState();
}

class _OTPCopyWidgetState extends State<OTPCopyWidget> {
  late OTPCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OTPCopyModel());
