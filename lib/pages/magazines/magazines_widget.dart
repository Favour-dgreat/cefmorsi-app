...
class MagazinesWidget extends StatefulWidget {
  const MagazinesWidget({super.key});

  @override
  State<MagazinesWidget> createState() => _MagazinesWidgetState();
}

class _MagazinesWidgetState extends State<MagazinesWidget> {
  late MagazinesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MagazinesModel());
  }
